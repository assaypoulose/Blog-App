        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-4 sm:flex-row justify-between">
                ...
                <Select onChange={(e) => setFormData({ ...formData, category: e.target.value}) }
                    ...
                    <option value="laravel">Larvel</option>
            ...
            placeholder='Write something...' className='h-72 mb-12' required onChange={(value) => {
                setFormData({ ...formData, content: value});
            }}/>
            <Button type='submit' gradientDuoTone='purpleToPink'>Update</Button>
            {
                publisError && <Alert color='failure' className='mt-5'>{publisError}</Alert>
            }
        </form>
    </div>
  )
